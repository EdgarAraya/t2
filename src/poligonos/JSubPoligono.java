 ...
 * @author Edgar-pc
 */
public class JSubPoligono extends javax.swing.JFrame {

    /**
     * Creates new form JSubPoligono
     */
    private static JSubPoligono p;
    
    public static JSubPoligono getInstance(){
        if (p==null){
            p = new JSubPoligono();
        }
        return p;  
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 533, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       for(int i = 0; i<listaDeSubPoligonos.getSize();i++){
           jComboBox1.addItem(listaDeSubPoligonos.getPoligonos().get(i).toString());
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JSubPoligono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JSubPoligono().setVisible(true);
            }
        });
    }
